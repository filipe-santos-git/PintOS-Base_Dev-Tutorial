...
thread_unblock (struct thread *t) 
{
  ...
  //TODO: INSERIR AS THREADS NA READY_lIST ORDENADO PRA DAR CERTO
...
thread_set_nice (int nice) 
{
  ...
  //TODO: VERIFICAÇÃO SE A PRIORIDADE REALMENTE PRECISA SER TROCADA
...
//updates the priority of a thread based on the mlfqs formula
...
// updates recent cpu based on recent cpu formula
...
// updates load average based on load average formula
void mlfqs_update_load_avg(void){
